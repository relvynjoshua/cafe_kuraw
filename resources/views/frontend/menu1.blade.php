...
<html lang="zxx">
   ...
   <head>
      ...
      <!-- venobox -->
      <link rel="stylesheet" href="assets/venobox/css/venobox.min.css" />
      <!-- Style CSS --> 
                           ...
                           <ul class="navbar-nav">
                              ...
                              <li class="dropdown"><a class="nav-link" href="services.html">Services</a>
                                 <ul class="dropdown-menu">
                                    ...
                                    <li><a href="form-page.html">Forms</a></li>
               ...
               <div class="col-12 mx-auto text-center wow fadeInDown">
                  <div class="portfolio-filter-menu">
                     <ul>
                        ...
                        <li class="filter"  data-filter=".one">Espresso</li>
            ...
            <div class="row project-list">
               <div class="col-lg-4 col-md-6 col-12 mb-lg-4 mb-md-4 mb-4 one">
                  <figure class="service-list-item shadow">
                     <img class="img-fluid" src="assets/img/menu/espresso.PNG" alt="" />
                     <figcaption>
                        <div class="port-icon mt-3">
                           <a class="icon-ho venobox" href="assets/img/menu/espresso.PNG"></i></a>
                        </div>
               ...
               <div class="col-lg-4 col-md-6 col-12 mb-lg-4 mb-md-4 mb-4 one">
                  <figure class="service-list-item shadow">
                     <img class="img-fluid" src="assets/img/menu/icedamericano.jpg" alt="" />
                     <figcaption>
                        <div class="port-icon mt-3">
               ...
               <div class="col-lg-4 col-md-6 col-12 one">
                  <figure class="service-list-item shadow">
                     <img class="img-fluid" src="assets/img/menu/icedspanishlatte.jpg" alt="" />
                     <figcaption>
                        <div class="port-icon mt-3">
                           <a class="icon-ho venobox"></i></a>
                        </div>
               ...
               <div class="col-lg-4 col-md-6 col-12 one">
                  <figure class="service-list-item shadow">
                     <img class="img-fluid" src="assets/img/menu/iceddirtymatcha.jpg" alt="" />
                     <figcaption>
                        <div class="port-icon mt-3">
                           <a class="icon-ho venobox"></i></a>
                        </div>
               ...
               <div class="col-lg-4 col-md-6 col-12 one">
                  <figure class="service-list-item shadow">
                     <img class="img-fluid" src="assets/img/menu/icedcaramelm.jpg" alt="" />
                     <figcaption>
                        <div class="port-icon mt-3">
                           <a class="icon-ho venobox"></i></a>
                        </div>
               ...
               <div class="col-lg-4 col-md-6 col-12 two">
                  <figure class="service-list-item shadow">
                     <img class="img-fluid" src="assets/img/menu/darckchoco.jpg" alt="" />
                     <figcaption>
                        <div class="port-icon mt-3">
                           <a class="icon-ho venobox"></i></a>
                        </div>
               ...
               <div class="col-lg-4 col-md-6 col-12 two">
                  <figure class="service-list-item shadow">
                     <img class="img-fluid" src="assets/img/menu/strawberrylatte.jpg" alt="" />
                     <figcaption>
                        <div class="port-icon mt-3">
                           <a class="icon-ho venobox"></i></a>
                        </div>
               ...
               <div class="col-lg-4 col-md-6 col-12 two">
                  <figure class="service-list-item shadow">
                     <img class="img-fluid" src="assets/img/menu/matchalatte.jpg" alt="" />
                     <figcaption>
                        <div class="port-icon mt-3">
                           <a class="icon-ho venobox"></i></a>
                        </div>
               ...
               <div class="col-lg-4 col-md-6 col-12 three">
                  <figure class="service-list-item shadow">
                     <img class="img-fluid" src="assets/img/menu/chocomt.jpg" alt="" />
                     <figcaption>
                        <div class="port-icon mt-3">
                           <a class="icon-ho venobox"></i></a>
                        </div>
               ...
               <div class="col-lg-4 col-md-6 col-12 three">
                  <figure class="service-list-item shadow">
                     <img class="img-fluid" src="assets/img/menu/wintermelonmt.jpg" alt="" />
                     <figcaption>
                        <div class="port-icon mt-3">
                           <a class="icon-ho venobox"></i></a>
                        </div>
               ...
               <div class="col-lg-4 col-md-6 col-12 three">
                  <figure class="service-list-item shadow">
                     <img class="img-fluid" src="assets/img/menu/matchamt.jpg" alt="" />
                     <figcaption>
                        <div class="port-icon mt-3">
                           <a class="icon-ho venobox"></i></a>
                        </div>
               ...
               <div class="col-lg-4 col-md-6 col-12 four">
                  <figure class="service-list-item shadow">
                     <img class="img-fluid" src="assets/img/menu/greenapple.jpg" alt="" />
                     <figcaption>
                        <div class="port-icon mt-3">
                           <a class="icon-ho venobox"></i></a>
                        </div>
               ...
               <div class="col-lg-4 col-md-6 col-12 four">
                  <figure class="service-list-item shadow">
                     <img class="img-fluid" src="assets/img/menu/raspberry.jpg" alt="" />
                     <figcaption>
                        <div class="port-icon mt-3">
                           <a class="icon-ho venobox"></i></a>
                        </div>
               ...
               <div class="col-lg-4 col-md-6 col-12 four">
                  <figure class="service-list-item shadow">
                     <img class="img-fluid" src="assets/img/menu/mixedberries.jpg" alt="" />
                     <figcaption>
                        <div class="port-icon mt-3">
                           <a class="icon-ho venobox"></i></a>
                        </div>
               ...
               <div class="col-lg-4 col-md-6 col-12 five">
                  <figure class="service-list-item shadow">
                     ...
                     <figcaption>
                        ...
                        <div class="service-list-des">
                           <h4>WAFFLE (CHOCOLATE/CARAMEL)</h4>
                           <p>Lorem ipsum dolor sit amet consectetur ullamco adipiscing elit, sed do eiusmod tempor exercitat incididunt ut labore.</p>
                           <div class="price-order">
                           <h5>₱79</h5>
                           <button class="order-now-btn">ORDER NOW</button>
