    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-2 sidebar p-3">
                ...
                <a href="{{ route('cashierReservation.index') }}" class="active">
                    ...
                    <div class="reservation-details">
                        ...
                        <form action="{{ route('cashierReservation.store') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="time" name="reservation_time" id="reservationTime" class="form-control"
                                    required>
                            </div>
                            <div class="form-group mb-3">
                ...
                for (let j = 0; j < 7; j++) {
                    ...
                    if ((i === 0 && j < firstDayOfWeek) || date > lastDay.getDate()) {
                        ...
                        // Highlight booked dates
                            ...
                            console.log(`Booked Date Found: ${fullDate}`); // Debugging log
